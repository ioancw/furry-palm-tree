...
let x = compress ["a";"a";"a";"a";"b";"c";"c";"a";"a";"d";"e";"e";"e";"e"]
...
let encode2 xs = 
    ...
    |> List.map (fun l -> (l.Length, l.Head))
    |> List.map (fun (a, b) ->
                    if a > 1 then Multiple(a, b) else Single b)
...
let encoded : 'a Encoding list= encode21 ["a";"a";"a";"a";"b";"c";"c";"a";"a";"d";"e";"e";"e";"e"]
decode encoded 
