...
let convertArabicToRomanII arabic =
    ...
    [ ordinal 1000 |> toRomanII ("M", "", "")
      ordinal 100 |> toRomanII ("C", "D", "M")
      ordinal 10 |> toRomanII ("X", "L", "C")
      ordinal 1 |> toRomanII ("I", "V", "X") ]
    |> List.fold (+) ""

[ 1 .. 4000 ] |> List.map convertArabicToRomanII

convertArabicToRomanII 1
